            ...
            <div className="p-5 space-y-3">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex gap-1">
                  {selectedItem.badges?.includes('Signature') && <span className="text-[10px] font-bold px-2 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30">🌟 Signature</span>}
                  {selectedItem.badges?.includes('Nouveau') && <span className="text-[10px] font-bold px-2 py-1 rounded-full bg-orange-500/20 text-orange-300 border border-orange-500/30">🔥 Nouveau</span>}
                  {selectedItem.badges?.includes('Végétarien') && <span className="text-[10px] font-bold px-2 py-1 rounded-full bg-green-500/20 text-green-300 border border-green-500/30">🍃 Végétarien</span>}
                </div>
              </div>
